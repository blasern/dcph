...
test_that("cover distances work", {
  ...
  expect_equal(cover_distance(cover1, cover2, metric = "vi"), 0.333044760052531)
  expect_equal(cover_distance(cover1, cover2, metric = "bottleneck", dim = 0), 5.25019588636283)
  expect_equal(cover_distance(cover1, cover2, metric = "bottleneck", dim = 1), 2.07656484777033)
  expect_equal(cover_distance(cover1, cover2, metric = "interleaving"), 2.76307092273138)
})
